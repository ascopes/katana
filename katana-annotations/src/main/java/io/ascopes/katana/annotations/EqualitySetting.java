...
/**
 * Equality and identity generation policy. This generates an override for
 * {@link Object#equals(Object)} and {@link Object#hashCode()}.
 *
 * @author Ashley Scopes
 * @since 0.0.1
 */
public enum EqualitySetting implements AttributePolicy {
  /**
   * Inherit the setting.
   */
  INHERIT {
  ...
  /**
   * Generate default {@link #equals(Object)} and {@link #hashCode()} methods that compare
   * defined attributes. All attributes will be considered in these methods unless explicitly
   * marked with {@link Exclude} (i.e. {@literal @Exclude(Equality.class)}).
   */
  INCLUDE_ALL {
    /** {@inheritDoc} */
    @Override
  ...
  /**
   * Generate default {@link #equals(Object)} and {@link #hashCode()} methods that compare
   * defined attributes. No attributes will be considered in these methods unless explicitly
   * marked with {@link Include} (i.e. {@literal @Include(Equality.class)}).
   */
  EXCLUDE_ALL {
    /** {@inheritDoc} */
    @Override
  ...
  /**
   * Use custom implementations for equality and identity. This requires two static methods
