 ...
 * @since 0.1.0
 */
internal enum class ModuleMode(
   ...
   */
  NON_MODULE(StandardLocation.SOURCE_PATH, StandardLocation.MODULE_SOURCE_PATH),
  ...
  companion object {
     ...
     */
    fun getModuleModeFor(location: Location): ModuleMode? {
      val baseLocation = (location as? JavaRamModuleLocation)
          ?.parentLocation
          ?: location
