...
public final class AttributeDescriptor {
  ...
  private AttributeDescriptor(AttributeDescriptorBuilder builder) {
   ...
   */
  @MustCall("build")
  public static AttributeDescriptorBuilder builder() {
    return new AttributeDescriptorBuilder();
  }
  ...
  @MustCall("build")
  public static final class AttributeDescriptorBuilder
      implements ObjectBuilder<AttributeDescriptor> {
    ...
    private AttributeDescriptorBuilder() {
    }
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder getter(ExecutableElement getter) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder name(String name) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder identifier(String identifier) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder type(TypeName type) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder fieldVisibility(Visibility fieldVisibility) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder finalField(Boolean finalField) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder transientField(Boolean transientField) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder setterEnabled(Boolean setterEnabled) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder includeInToString(Boolean includeInToString) {
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder includeInEqualsAndHashCode(
     ...
     * @return this builder.
     */
    public AttributeDescriptorBuilder deprecatedAnnotation(
    ...
    public AttributeDescriptor build() {
      return new AttributeDescriptor(this);
    }
  }
}
